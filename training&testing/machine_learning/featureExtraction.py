   ...
   # cnt = 0 #for quick test
    ...
    #    import entities
       ...
       #     citationent_X = np.append(citationent_X, [0])
        ...
        provision_ent_X = np.append(provision_ent_X, row['provision ent'])
        court_ent_X = np.append(court_ent_X, row['court ent'])
        casename_ent_X = np.append(casename_ent_X, row['case name ent'])
        judge_ent_X = np.append(judge_ent_X, row['judge ent'])
        instrument_ent_X = np.append(instrument_ent_X, row['instrument ent'])
        citation_ent_X = np.append(citation_ent_X, row['citation bl ent'])
        
        
        if row['case name ent'] == '0' and row['judge ent'] == '0':
            person_ent_X = np.append(person_ent_X, row['person ent'])
        else: 
            person_ent_X = np.append(person_ent_X, [0])
        if row['citation bl ent'] == '0':
        ...
        time_ent_X = np.append(loc_ent_X, row['time ent'])
        gpe_ent_X = np.append(loc_ent_X, row['gpe ent'])
        fac_ent_X = np.append(loc_ent_X, row['fac ent'])
        ordinal_ent_X = np.append(loc_ent_X, row['ordinal ent'])
